...
<title>${siteName!""}|教师管理-${title!""}</title>
                ...
                <form class="pull-right search-bar" method="get" action="list" student="form">
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      教师名称 <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">教师名称</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!""}" name="user.nickName" placeholder="请输入教师名称">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as teacher>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${teacher.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${teacher.user.nickName}</td>
<#--                        <td style="vertical-align:middle;">-->
<#--                        	<#if student.status == 1>-->
...
<#--                        </td>-->
                          <td style="vertical-align:middle;">
                                  <#if teacher.user.sex == 1>
                                      男
                                 </#if>
                              	<#if teacher.user.sex == 2>
                                    女
                                </#if>
                          ...
                          <td align="center">${teacher.teacherSno!""}</td>
                          <td align="center">${teacher.user.email!""}</td>
                          <td align="center">${teacher.user.mobile!""}</td>
                          <td align="center">${teacher.teacherType.name!""}</td>
