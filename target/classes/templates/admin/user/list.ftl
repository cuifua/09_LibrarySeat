            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">昵称</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${nickName!""}" name="nickName" placeholder="请输入昵称">
              ...
              <div class="card-body">
                ...
                <ul class="pagination ">
                  ...
                  <#else>
                  <li><a href="list?nickName=${nickName!""}&currentPage=1">«</a></li>
                  </#if>
                  ...
                  <li class="disabled"><span>»</span></li>
                  <#else>
                  <li><a href="list?nickName=${nickName!""}&currentPage=${pageBean.totalPage}">»</a></li>
                  </#if>
