                ...
                <div class="row">
                    ...
                    <#include "../common/third-menu.ftl"/>
                      ...
                      <tr>
                          ...
                          <td style="vertical-align:middle;">${read.name!""}</td>
                          <td align="center">${read.row!""}</td>
                          <td align="center">${read.lie!""}</td>
                          <td align="center">${read.row*read.lie!""}</td>
                          <td align="center">${read.readingType.name!""}</td>
                      </tr>
                      </#list>
                      <#else>
    ...
    function deleteReq(id,url){
        $.ajax({
            ...
            success:function(data){
                if(data.code == 0){
                    showSuccessMsg('阅读室删除成功!',function(){
