                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">${student.user.nickName}</td>
<#--                        <td style="vertical-align:middle;">-->
<#--                        	<#if student.status == 1>-->
...
<#--                        </td>-->
                          ...
                          <td align="center">${student.studentCredits!""}</td>
                          <td align="center">${student.user.email!""}</td>
                          <td align="center">${student.user.mobile!""}</td>
                          <td align="center">${student.clazz.claname!""}</td>
